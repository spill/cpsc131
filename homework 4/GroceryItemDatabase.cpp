...
#include "GroceryItemDatabase.hpp" // GroceryItemDatabase declaration
/////////////////////// END-TO-DO (1) ////////////////////////////
...
GroceryItemDatabase::GroceryItemDatabase( const std::string & filename )
{
  ...
  ///////////////////////// TO-DO (2) //////////////////////////////
    ...
    ///        Read grocery items until end of file pushing each grocery item into the data store as they're read.
        GroceryItem item;
         while (fin >> item) { // Assumes the overloaded operator>> for GroceryItem is implemented correctly
        _data[item.upcCode()] = item;
    }
  /////////////////////// END-TO-DO (2) ////////////////////////////
...
///////////////////////// TO-DO (3) //////////////////////////////
  ...
  GroceryItem* GroceryItemDatabase::find(const std::string& upcCode)
{
    auto it = _data.find(upcCode);
    if (it != _data.end()) {
        return &(it->second); // Address of the GroceryItem in the map
    }
