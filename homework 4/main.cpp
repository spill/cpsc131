...
int main()
{
  try
  {
    ...
    ///////////////////////// TO-DO (2) //////////////////////////////
      ...
      ///
      auto shoppingCarts = myGroceryStore.makeShoppingCarts();
    /////////////////////// END-TO-DO (2) ////////////////////////////
    ...
    ///////////////////////// TO-DO (3) //////////////////////////////
      ...
      ///
      auto todaysSales = myGroceryStore.ringUpCustomers(shoppingCarts);
    /////////////////////// END-TO-DO (3) ////////////////////////////
    ...
    ///////////////////////// TO-DO (4) //////////////////////////////
      ...
      /// store's inventory.
      ///
              auto& inventory = myGroceryStore.inventory(); // returned by reference, retrieves the inventory of myGroceryStore.
              const std::string frozenOmeletUPC = "00041331092609";
              inventory.erase(frozenOmeletUPC); // removes the frozen omelet 
    /////////////////////// END-TO-DO (4) ////////////////////////////
    ...
    ///////////////////////// TO-DO (5) //////////////////////////////
      ...
      /// collection of items sold.
        myGroceryStore.reorderItems(todaysSales, std::cout); 
    /////////////////////// END-TO-DO (5) ////////////////////////////
  }
