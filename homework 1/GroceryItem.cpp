...
std::istream & operator>>( std::istream & stream, GroceryItem & groceryItem )
{
  ///////////////////////// TO-DO (21) //////////////////////////////
    ...
    if ( stream >> std::quoted(productName) >> std::ws &&  
           ...
           stream >> price )
    {
        // Create a temporary GroceryItem and then move it to the given parameter
        GroceryItem tempItem(upcCode, brandName, productName, price);
